...
CITIES: dict[str, list[tuple]] = {
    "ES": [("Madrid", 40.42, -3.70, "28"), ("Barcelona", 41.39, 2.17, "08"),
           ("Valencia", 39.47, -0.38, "46"), ("Sevilla", 37.39, -5.98, "41"),
           ("Zaragoza", 41.65, -0.89, "50"), ("Malaga", 36.72, -4.42, "29"),
           ("Bilbao", 43.26, -2.93, "48"), ("Murcia", 37.99, -1.13, "30"),
           ("Palma", 39.57, 2.65, "07"), ("Las Palmas", 28.12, -15.44, "35"),
           ("Vigo", 42.24, -8.72, "36"), ("Valladolid", 41.65, -4.72, "47")],
    "FR": [("Paris", 48.86, 2.35, "75"), ("Lyon", 45.76, 4.84, "69"),
           ("Marseille", 43.30, 5.37, "13"), ("Toulouse", 43.60, 1.44, "31"),
           ("Nantes", 47.22, -1.55, "44"), ("Bordeaux", 44.84, -0.58, "33")],
    "DE": [("Berlin", 52.52, 13.40, "10"), ("Munchen", 48.14, 11.58, "80"),
           ("Hamburg", 53.55, 9.99, "20"), ("Koln", 50.94, 6.96, "50"),
           ("Frankfurt", 50.11, 8.68, "60"), ("Stuttgart", 48.78, 9.18, "70")],
    "IT": [("Roma", 41.90, 12.50, "00"), ("Milano", 45.46, 9.19, "20"),
           ("Napoli", 40.85, 14.27, "80"), ("Torino", 45.07, 7.69, "10"),
           ("Bologna", 44.49, 11.34, "40")],
    "PT": [("Lisboa", 38.72, -9.14, "10"), ("Porto", 41.15, -8.61, "40"),
           ("Braga", 41.55, -8.43, "47"), ("Faro", 37.02, -7.93, "80")],
    "GB": [("London", 51.51, -0.13, "EC"), ("Manchester", 53.48, -2.24, "M1"),
           ("Birmingham", 52.49, -1.89, "B1"), ("Edinburgh", 55.95, -3.19, "EH"),
           ("Bristol", 51.45, -2.59, "BS")],
    "NL": [("Amsterdam", 52.37, 4.90, "10"), ("Rotterdam", 51.92, 4.48, "30"),
           ("Utrecht", 52.09, 5.12, "35")],
    "BE": [("Brussel", 50.85, 4.35, "10"), ("Antwerpen", 51.22, 4.40, "20")],
    "IE": [("Dublin", 53.35, -6.26, "D0"), ("Cork", 51.90, -8.47, "T1")],
    "PL": [("Warszawa", 52.23, 21.01, "00"), ("Krakow", 50.06, 19.94, "30"),
           ("Wroclaw", 51.11, 17.04, "50"), ("Gdansk", 54.35, 18.65, "80")],
    ...
    "US": [("New York", 40.71, -74.01, "10"), ("Miami", 25.76, -80.19, "33"),
           ("Chicago", 41.88, -87.63, "60"), ("Austin", 30.27, -97.74, "78")],
...
PRODUCT_TAXONOMY: list[tuple] = [
    ...
    ("LEISURE", "Sports", ["Yoga Mat", "Dumbbell", "Running Shoes", "Bike Helmet"], 9, 590, 1.4),
    ...
    ("TRAVEL", "Extras", ["Checked Bag", "Seat Selection", "Insurance", "Transfer"], 6, 180, 2.6),
    ...
    ("ALCOHOL", "Wine and Spirits", ["Wine Case", "Spirits Bottle", "Craft Beer Pack"], 9, 420, 1.8),
]
...
PRODUCT_ADJECTIVES = [
    "Classic", "Pro", "Lite", "Max", "Essential", "Premium", "Studio", "Compact",
    "Ultra", "Everyday", "Signature", "Original", "Nordic", "Urban", "Vintage",
    "Eco", "Advanced", "Core", "Select", "Heritage", "Active", "Smart", "Prime",
]
PRODUCT_BRANDS = [
    "Alderon", "Belmonte", "Cantera", "Dovela", "Estrada", "Farolet", "Granara",
    "Halcyon", "Ibarra", "Jarama", "Kestrel", "Lumin", "Montseny", "Nervion",
    "Ordesa", "Palmar", "Quintal", "Ribera", "Sanabria", "Torcal", "Umbria",
    "Valdivia", "Wexford", "Xanthe", "Yesera", "Zurbano", "Aranda", "Brava",
    "Cierra", "Duero", "Ebro", "Fresneda", "Gaviota", "Hontanar", "Isar",
]
...
DEVICE_MODELS: list[tuple] = [
    ("iOS", ["17.4", "17.6", "18.1", "18.3", "19.0"], "mobile",
     ["iPhone 14", "iPhone 15", "iPhone 15 Pro", "iPhone 16", "iPhone 16 Pro", "iPhone SE"]),
    ("iPadOS", ["17.5", "18.2", "19.0"], "tablet",
     ["iPad Air", "iPad Pro 11", "iPad mini"]),
    ("Android", ["13", "14", "15", "16"], "mobile",
     ["Galaxy S23", "Galaxy S24", "Galaxy A54", "Pixel 8", "Pixel 9",
      "Xiaomi 14", "Redmi Note 13", "OnePlus 12"]),
    ("Android", ["13", "14", "15"], "tablet", ["Galaxy Tab S9", "Redmi Pad"]),
    ("Windows", ["10", "11"], "desktop", ["Windows PC"]),
    ("macOS", ["14.5", "15.1", "15.4", "26.0"], "desktop",
     ["MacBook Air", "MacBook Pro", "iMac", "Mac mini"]),
    ("Linux", ["6.8", "6.11"], "desktop", ["Linux Desktop"]),
]
BROWSERS = [("Chrome", 0.446), ("Safari", 0.281), ("Edge", 0.108),
            ("Firefox", 0.074), ("Samsung Internet", 0.051),
            ("Opera", 0.023), ("Brave", 0.017)]
...
ASN_POOL: list[tuple] = [
    ...
    (64512, "Telcoiberia Fibra", "residential"), (64513, "Nubia Movil ES", "residential"),
    (64514, "Redes del Sur", "residential"), (64515, "CableAtlantico", "residential"),
    (64516, "Lusonet", "residential"), (64517, "Atlantica Telecom", "residential"),
    (64518, "Reseau Hexagone", "residential"), (64519, "Libre Telecom FR", "residential"),
    (64520, "Rheinnetz", "residential"), (64521, "Bundesfaser", "residential"),
    (64522, "Adriatica Net", "residential"), (64523, "Ventiquattro Telecom", "residential"),
    (64524, "Albion Broadband", "residential"), (64525, "Thames Fibre", "residential"),
    (64526, "Lagelijn", "residential"), (64527, "Benelux Net", "residential"),
    (64528, "Wisla Telekom", "residential"), (64529, "Nordljus AB", "residential"),
    (64530, "Sundnet", "residential"), (64531, "Fjordlink", "residential"),
    (65001, "Cirrus Hosting", "datacenter"), (65002, "Northstack Cloud", "datacenter"),
    (65003, "Blueforge Compute", "datacenter"), (65004, "Kernel Droplets", "datacenter"),
    (65005, "Bauhaus Servers", "datacenter"), (65006, "Aquila Hosting", "datacenter"),
    (65007, "Vectra Cloud", "datacenter"), (65008, "Contado Systems", "datacenter"),
    (65101, "Veilnet Privacy", "vpn"), (65102, "Tunnelworks", "vpn"),
    (65103, "Cloakline VPN", "vpn"), (65104, "Shroud Networks", "vpn"),
    (65201, "Movilia Wireless", "mobile"), (65202, "Airwave Mobile", "mobile"),
    (65203, "Celeris Mobile UK", "mobile"), (65204, "Rapida Mobile IT", "mobile"),
]
...
GROUP_PREFIX = ["Grupo", "Holding", "Corporacion", "Compania", "Sociedad",
                "Inversiones", "Participaciones", "Capital", "Grupo Industrial"]
GROUP_ROOT = [
    "Aranjuez", "Bidasoa", "Cinca", "Duero", "Ebro", "Fluvia", "Genil", "Huerva",
    "Iregua", "Jalon", "Kadagua", "Llobregat", "Mijares", "Najerilla", "Odiel",
    "Pisuerga", "Queiles", "Riaza", "Segura", "Tormes", "Ulla", "Verde",
    "Xuquer", "Yeltes", "Zadorra", "Aragon", "Bernesga", "Carrion", "Deva",
    "Esla", "Flumen", "Gallego", "Henares", "Isuela", "Jarama", "Kamino",
]
GROUP_SUFFIX = ["SA", "SL", "SAU", "Holdings BV", "Group PLC", "GmbH",
                "SARL", "SpA", "AB", "AS", "NV", "Limited", "Holdings SA"]

MERCHANT_PREFIX = ["Casa", "Tienda", "Almacen", "Boutique", "Mercado", "Punto",
                   "Espacio", "Estudio", "Taller", "Bazar", "Central", "Norte",
                   "Sur", "Nova", "Bella", "Buena", "Gran", "Nueva", "Real"]
MERCHANT_ROOT = [
    "Aurora", "Bahia", "Calma", "Dorada", "Encina", "Fuente", "Gaviota", "Hoja",
    "Islas", "Jara", "Ladera", "Marea", "Nube", "Olivo", "Puerto", "Quilla",
    "Retama", "Sierra", "Tejo", "Umbria", "Vela", "Xara", "Yedra", "Zarza",
    "Almendro", "Brisa", "Cumbre", "Dehesa", "Estrella", "Faro", "Granada",
    "Hiedra", "Invierno", "Junco", "Kiwi", "Laurel", "Manzano", "Naranjo",
]
SITE_KINDS = ["web", "app_ios", "app_android", "marketplace", "pos_terminal",
              "call_center", "kiosk", "subscription_billing"]
...
JOB_TITLES = [
    ("Chief Executive Officer", 0), ("Chief Financial Officer", 1),
    ("Chief Risk Officer", 1), ("VP Operations", 2), ("VP Sales", 2),
    ("Head of Payment Operations", 3), ("Head of Risk", 3),
    ("Head of Account Management", 3), ("Finance Manager", 4),
    ("Account Manager", 5), ("Payment Operations Agent", 5),
    ("Risk Analyst", 5), ("Data Analyst", 5), ("Settlement Analyst", 5),
    ("Dispute Specialist", 5), ("Onboarding Specialist", 5),
]
...
def name_pools(seed: int) -> dict[str, np.ndarray]:
    ...
    locales = {
        ...
        "GB": "en_GB", "NL": "nl_NL", "BE": "nl_BE", "IE": "en_IE", "PL": "pl_PL",
        "SE": "sv_SE", "DK": "da_DK", "NO": "no_NO", "FI": "fi_FI", "AT": "de_AT",
        "CH": "de_CH", "CZ": "cs_CZ", "HU": "hu_HU", "RO": "ro_RO", "BG": "bg_BG",
        "GR": "el_GR", "US": "en_US", "MX": "es_MX", "BR": "pt_BR", "MA": "fr_FR",
        "TR": "tr_TR", "SG": "en_US", "JP": "ja_JP", "LT": "lt_LT", "MT": "en_GB",
    }
...
EMAIL_DOMAINS = [
    ("gmail.com", 0.331), ("hotmail.com", 0.121), ("outlook.com", 0.094),
    ("yahoo.com", 0.061), ("icloud.com", 0.078), ("proton.me", 0.031),
    ("gmx.de", 0.024), ("web.de", 0.021), ("orange.fr", 0.019),
    ("free.fr", 0.014), ("telefonica.net", 0.017), ("terra.es", 0.009),
    ("libero.it", 0.016), ("sapo.pt", 0.011), ("wp.pl", 0.013),
    ("btinternet.com", 0.012), ("live.com", 0.028), ("me.com", 0.014),
    ("yandex.com", 0.006), ("zoho.com", 0.005), ("fastmail.com", 0.004),
    ("mail.ru", 0.003), ("aol.com", 0.007), ("tutanota.com", 0.003),
